...
if ( ! class_exists( 'Confucius_Custom_Posts_Widget' ) ) {

	class Confucius_Custom_Posts_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			$this->widget_name			= esc_html__( 'Custom Posts', 'confucius' );
			$this->widget_description 	= esc_html__( 'Display custom posts your site.', 'confucius' );
			$this->widget_id			= apply_filters( 'confucius_custom_posts_widget_ID', 'widget-custom-posts' );
			$this->widget_cssclass		= apply_filters( 'confucius_custom_posts_widget_cssclass', 'widget-custom-posts custom-posts' );
			$this->utility				= confucius_utility()->utility;
			$this->settings 			= array(
				'title' => array(
					'type'				=> 'text',
					'value'				=> esc_html__( 'Custom Posts', 'confucius' ),
				...
				'terms_type' => array(
					...
					'options'			=> array(
						'category_name' => array(
							'label'		=> esc_html__( 'Category', 'confucius' ),
							'slave'		=> 'terms_type_post_category',
						),
						'tag'			=> array(
							'label'		=> esc_html__( 'Tag', 'confucius' ),
							'slave'		=> 'terms_type_post_tag',
						),
						'post_format'	=> array(
							'label'		=> esc_html__( 'Post Format', 'confucius' ),
							'slave'		=> 'terms_type_post_format',
						),
					),
					'label'				=> esc_html__( 'Choose taxonomy type', 'confucius' ),
				),
				'category_name' => array(
					'type'				=> 'select',
					'size'				=> 1,
					...
					'options'			=> false,
					'label'				=> esc_html__( 'Select category', 'confucius' ),
					'multiple'			=> true,
					'placeholder'		=> esc_html__( 'Select category', 'confucius' ),
				...
				'tag' => array(
					...
					'options'			=> false,
					'label'				=> esc_html__( 'Select tags', 'confucius' ),
					'multiple'			=> true,
					'placeholder'		=> esc_html__( 'Select tags', 'confucius' ),
				...
				'post_format' => array(
					...
					'options'			=> false,
					'label'				=> esc_html__( 'Select post format', 'confucius' ),
					'multiple'			=> true,
					'placeholder'		=> esc_html__( 'Select post format', 'confucius' ),
				...
				'posts_per_page' => array(
					...
					'max_value'			=> 50,
					'min_value'			=> 0,
					'label'				=> esc_html__( 'Posts count ( Set 0 to show all. )', 'confucius' ),
				),
				'post_offset' => array(
					'type'				=> 'stepper',
					'value'				=> '0',
					...
					'min_value'			=> '0',
					'step_value'		=> '1',
					'label'				=> esc_html__( 'Offset post', 'confucius' ),
				),
				'image_visibility'     => array(
					'type'  => 'switcher',
					'value' => 'true',
					'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label' => esc_html__( 'Display thumbnails', 'confucius' ),
				),
				'title_length' => array(
					'type'				=> 'stepper',
					'value'				=> '10',
					...
					'min_value'			=> '0',
					'step_value'		=> '1',
					'label'				=> esc_html__( 'Title words length ( Set 0 to hide title. )', 'confucius' ),
				),
				'excerpt_length' => array(
					...
					'min_value'			=> '0',
					'step_value'		=> '1',
					'label'				=> esc_html__( 'Excerpt words length ( Set 0 to hide excerpt. )', 'confucius' ),
				),
				'meta_data' => array(
					'type'				=> 'checkbox',
					'value'				=> array(
					...
					'options'				=> array(
						'date'				=> esc_html__( 'Date', 'confucius' ),
						'author'			=> esc_html__( 'Author', 'confucius' ),
						'comment_count'		=> esc_html__( 'Comment count', 'confucius' ),
						'category'			=> esc_html__( 'Category', 'confucius' ),
						'post_tag'			=> esc_html__( 'Tag', 'confucius' ),
						'more_button'		=> esc_html__( 'More Button', 'confucius' ),
					),
					'label'				=> esc_html__( 'Display post meta data', 'confucius' ),
				),
				'button_text' => array(
					'type'				=> 'text',
					'value'				=> 'Read More',
					'label'				=> esc_html__( 'Post read more button label', 'confucius' ),
				),
			);
					...
					if ( $holder_view_dir ) {
						foreach ( $posts as $post ) {
							...
							$image = $this->utility->media->get_image( array(
								...
								'size'			=> 'confucius-thumb-m',
								'mobile_size'	=> 'confucius-thumb-m',
	...
	add_action( 'widgets_init', 'confucius_register_custom_posts_widget' );
	function confucius_register_custom_posts_widget() {
		register_widget( 'Confucius_Custom_Posts_Widget' );
	}
}