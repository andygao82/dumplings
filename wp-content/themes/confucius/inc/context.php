 ...
 * @return object
 */
function confucius_utility() {
	return confucius_theme()->get_core()->modules['cherry-utility'];
}
 ...
 * @return void
 */
function confucius_header_class( $classes = array() ) {
	$classes[] = 'site-header';
	...
	echo confucius_get_container_classes( $classes, 'header' );
}
 ...
 * @return void
 */
function confucius_content_class( $classes = array() ) {
	$classes[] = 'site-content';
	echo confucius_get_container_classes( $classes, 'content' );
}
 ...
 * @return void
 */
function confucius_footer_class( $classes = array() ) {
	$classes[] = 'site-footer';
	$classes[] = get_theme_mod( 'footer_layout_type' );
	echo confucius_get_container_classes( $classes, 'footer' );
}
 ...
 * @return string
 */
function confucius_get_container_classes( $classes, $target = 'content' ) {
	switch ( $target ) {
		case 'header':
 ...
 * @return void
 */
function confucius_primary_content_class( $classes = array() ) {
	echo confucius_get_layout_classes( 'content', $classes );
}
 ...
 * @return void
 */
function confucius_sidebar_class( $classes = array() ) {
	echo confucius_get_layout_classes( 'sidebar', $classes );
}
 ...
 * @return string
 */
function confucius_get_layout_classes( $layout = 'content', $classes = array() ) {
	...
	$layout_classes = ! empty( confucius_theme()->layout[ $sidebar_position ][ $sidebar_width ][ $layout ] ) ? confucius_theme()->layout[ $sidebar_position ][ $sidebar_width ][ $layout ] : array();
	...
	$layout_classes = apply_filters( "confucius_{$layout}_classes", $layout_classes );
 ...
 * @return string|void
 */
function confucius_posts_list_class( $classes = array(), $echo = true ) {
	$layout_type      = get_theme_mod( 'blog_layout_type', confucius_theme()->customizer->get_default( 'blog_layout_type' ) );
	...
	foreach ( $sidebars as $sidebar ) {
		if ( confucius_widget_area()->is_active_sidebar( $sidebar ) ) {
			$has_sidebars = true;
		}
	}
	...
	$classes = apply_filters( 'confucius_posts_list_class', $classes );
