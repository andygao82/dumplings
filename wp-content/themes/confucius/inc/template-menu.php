...
function confucius_main_menu() {
	...
	<nav id="site-navigation" class="main-navigation" role="navigation">
		...
		<?php
			$args = apply_filters( 'confucius_main_menu_args', array(
				'theme_location'   => 'main',
				'container'        => '',
				'menu_id'          => 'main-menu',
				'fallback_cb'      => 'confucius_set_nav_menu',
				'fallback_message' => esc_html__( 'Set main menu', 'confucius' ),
			) );
 ...
 * @return void
 */
function confucius_footer_menu() {
	?>
	<nav id="footer-navigation" class="footer-menu" role="navigation">
	<?php
		$args = apply_filters( 'confucius_footer_menu_args', array(
			...
			'fallback_message' => esc_html__( 'Set footer menu', 'confucius' ),
		) );
 ...
 * @return string
 */
function confucius_get_social_list( $context, $type = 'icon' ) {
	static $instance = 0;
	$instance++;
	...
	$args = apply_filters( 'confucius_social_list_args', array(
		...
		'echo'             => false,
		'fallback_cb'      => 'confucius_set_nav_menu',
		'fallback_message' => esc_html__( 'Set social menu', 'confucius' ),
	), $context, $type );
 ...
 * @return null
 */
function confucius_set_nav_menu( $args ) {
