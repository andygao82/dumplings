...
if ( ! class_exists( 'Confucius_Widget_Area' ) ) {

	class Confucius_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'confucius_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'confucius_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'confucius_widget_area_classes', $classes, $area_id );
	...
	function confucius_widget_area() {
		return Confucius_Widget_Area::get_instance();
	}

	confucius_widget_area();
}
