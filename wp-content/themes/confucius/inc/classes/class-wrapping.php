 ...
 */
add_filter( 'template_include', array( 'Confucius_Wrapping', 'wrap' ), 99 );
add_filter( 'confucius_wrap_base', 'confucius_wrap_base_cpts' );
 ...
 */
function confucius_template_path() {
	return Confucius_Wrapping::$main_template;
}
 ...
 */
function confucius_template_base() {
	return Confucius_Wrapping::$base;
}

if ( ! class_exists( 'Confucius_Wrapping' ) ) {
	...
	class Confucius_Wrapping {
		...
		/**
		 * Initialize new instance of Confucius_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'confucius_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Confucius_Wrapping class.
		 *
		 * @since 1.0.0
 ...
 */
function confucius_wrap_base_cpts( $templates ) {
